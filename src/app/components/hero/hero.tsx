...
export default async function HeroSection() {
  ...
  try {
    ...
    return (
      ...
      // <Suspense fallback={<HeroSkeleton />}>
      //   <div className="relative flex flex-col py-16 lg:flex-col lg:pb-0 lg:mt-12 max-w-screen-lg m-auto">
      ...
      //       />
      //     </div>
      //     <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl m-auto">
      //       <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
      //         <h2 className="mb-5 font-sans text-3xl font-bold tracking-tight sm:text-4xl sm:leading-none">
      //           {data.attributes.hero.heading}
      //         </h2>
